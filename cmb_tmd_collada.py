...
TMD-CMB Collada Converter: This module write the TMD structure data into
Collada File Format (*.dae), when the animation file is a CMB Embedded
...
class ColladaAnimFileWriter:
    ...
    def dae_from_tmd_cmb_anim(self, saf_animation):
        ...
        for p_array_extraction_calc in collada_primitive_data:
            ...
            if contains_duplicate == True:
                ...
                pass # Means - No Duplication Faces
            ...
            zipped_p_array = zip(vertex_index, normal_index, uv_index, color_index)
            p_array_formed = []
        ...
        with open(os.path.join(standard_tmd_writer.new_folder, standard_tmd_writer.file_name) + "_" + standard_tmd_writer.animation_final_name + ".dae", 'w') as dae_file_writer:
            ...
            for number_geometry in number_of_object: # THIS WRITE THE CURRENT OBJECT ARRAYS (VERTEX, FACES, NORMALS, ETC)
                ...
                current_quantity_primitives = len(collada_polygon[number_geometry])
                ...
                collada_p_array_write = collada_p_array[number_geometry]
                for array_ready in collada_p_array_write:
            ...
            if self.saf_animation == True:
                ...
                test_anim = animation_file_process.ctmd_keyframes_converted_enum
                library_animations_header = f'  <library_animations>\n'
                dae_file_writer.write(library_animations_header)
                total_keyframes = animation_file_process.ctmd_anm_frames
                time_keyframe = 3 / 60
