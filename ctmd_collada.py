...
Custom TMD and Scripted Animation Collada Exporter: This module write the Standard TMD structure data and 
...
class ColladaAnimFileWriter:
    ...
    def dae_from_ctmdanim(self, saf_animation):
        ...
        collada_primitive_data = custom_tmd_decoder.collada_primitives
        collada_vertex_positions = custom_tmd_decoder.vertex_decoded
        ### VALUES FOR SOURCE ###
        global collada_uv
        ...
        # DATA WRITTER
        with open(os.path.join(custom_tmd_writer.custom_new_folder, custom_tmd_writer.custom_file_name) + "_" + custom_tmd_writer.custom_animation_final_name + ".dae", 'w') as dae_file_writer:
            ...
            number_of_object = range(0, custom_tmd.ctmd_nobj_expected)
            ...
            for number_geometry in number_of_object: # THIS WRITE THE CURRENT OBJECT ARRAYS (VERTEX, FACES, NORMALS, ETC)
                ...
                mesh_normals = custom_tmd_decoder.normal_decoded[number_geometry]
                ...
                for normal_in_array in custom_tmd_decoder.normal_decoded[number_geometry]:
                ...
                current_quantity_primitives = custom_tmd_structure.cprimitive_number_int[number_geometry]
            ...
            if self.saf_animation == True:
                ...
                total_keyframes = int(animation_file_process.ctmd_anm_frames)
                time_keyframe = 3 / 60
                for obj_anm_number in number_of_object:
                    ...
                    for key_frame, rot_loc in animation_file_process.ctmd_keyframes_converted_enum:
