...
class ColladaAnimFileWriter:
    ...
    def dae_from_tmdanim(self):
        ...
        with open(os.path.join(standard_tmd_writer.new_folder, standard_tmd_writer.file_name) + "_" + standard_tmd_writer.animation_final_name + ".dae", 'w') as dae_file_writer:
            ...
            test_anim = animation_file_process_batch.keyframes_converted_enum
            library_animations_header = f'  <library_animations>\n'
            dae_file_writer.write(library_animations_header)
            total_keyframes = int(sum(animation_file_process_batch.anm_frames) / 2) # ORIGINAL VALUE 2
            time_keyframe = 3 / 60 # Originally 6/60
            ...
            for obj_anm_number in number_of_object:
                ...
                for key_frame, rot_loc in animation_file_process_batch.keyframes_converted_enum:
        ...
        print("Collada File successfully converted - All animations merged")