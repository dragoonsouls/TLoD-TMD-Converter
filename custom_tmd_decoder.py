...
class CustomTmdInterpreter:
    ...
    def cprimitive_types_depacker(self, tmd_attribute): # THIS IS A SECTION FOR CALCULATE THE QUANTITY OF PRIMITIVES PACKETS IN EACH PRIMITIVE BLOCK
        ...
        for p_block_num in range(0, num_obj_ctmd): # HERE I LOOP IN THE NUMBER OF OBJECT AND PRIMITIVE BLOCK
            ...
            while num_prims != 0:
                ...
                if index_render_single in not_possible_render:
                    ...
                    exit()
                elif (index_render_single == 0) or (index_render_single == 2) or (index_render_single == 18):
                    print(f'Renderer 1')
                    break
        ...
        collada_primitives = primitive_block_dict
...
class CustomTmdVertexFixer:
    ...
    def vertex_decoder(self):
        ...
        for prims_inside_obj in primitive_index:
            ...
            decoded_vertex_inside_prim = [0] * (len(vertex_current_block))
            long_2_init = [0, 0, 0]
